...
Trophy.prototype.thophyWon = function () {
    ...
    //one events
    this.goal1000 = this.game.add.button(this.painel.x - this.painel.width * 0.365, this.painel.y * 1.8, 'trophy-btns', this.goal1000Act, this);
    ...
    this.match500 = this.game.add.button(this.goal1000.x + this.goal1000.width * 1.15, this.goal1000.y, 'trophy-btns', this.match500Act, this);
    ...
    this.kick5000 = this.game.add.button(this.match500.x + this.match500.width * 1.15, this.goal1000.y, 'trophy-btns', this.kick5000Act, this);
    ...
    //temp
    this.Money100 = this.game.add.button(this.kick5000.x + this.kick5000.width * 1.15, this.goal1000.y, 'trophy-btns', this.MoneyAct, this);
    this.Money100.anchor.set(0.5);
    this.Money100.animations.add('Money100available', [20], 10, false);
    this.Money100.animations.add('Money100enable', [21], 10, false);
    ...
    //temp
    this.doubleposts = this.game.add.button(this.Money100.x, this.postgoal.y, 'trophy-btns', this.DoublePostAct, this);
    this.doubleposts.anchor.set(0.5);
    this.doubleposts.animations.add('doublepostsavailable', [22], 10, false);
    this.doubleposts.animations.add('doublepostsenable', [23], 10, false);
    this.doubleposts.animations.play('doublepostsavailable', 5, true);
...
Trophy.prototype.MoneyAct = function () {
    'use strict';
    this.trophyNumber = 14;
    this.showModal();
};

Trophy.prototype.DoublePostAct = function () {
    'use strict';
    this.trophyNumber = 15;
    this.showModal();
};
...
Trophy.prototype.update = function () {
    ...
    if (registry.won100money < 1 || registry.won100money < "1") {
        this.Money100.animations.play('Money100available', 5, true);
    } else {
        this.Money100.animations.play('Money100enable', 5, true);
    }
    ...
    if (registry.won2Post < 1 || registry.won2Post < "1") {
        ...
        this.doubleposts.animations.play('doublepostsenable', 5, true);
    }
    ...
    switch (this.trophyNumber) {
        ...
        case 4:
            ...
            if (registry.won1000goal < 1 || registry.won1000goal < "1") {
                this.botText.text = "status: available " + (parseInt(registry.storiesGoals)) + "/1000";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 5:
            ...
            if (registry.won500Match < 1 || registry.won500Match < "1") {
                this.botText.text = "status: available " + (parseInt(registry.storiesMatches)) + "/500";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 6:
            ...
            if (registry.won5000kick < 1 || registry.won5000kick < "1") {
                this.botText.text = "status: available " + (parseInt(registry.storiesShots)) + "/5000";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 7:
            ...
            if (registry.wonPostGoal < 1 || registry.wonPostGoal < "1") {
                this.botText.text = "status: available " + (parseInt(registry.GoalPost)) + "/20";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 8:
            ...
            if (registry.wonDefGoal < 1 || registry.wonDefGoal < "1") {
                this.botText.text = "status: available " + (parseInt(registry.GoalDef)) + "/20";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 9:
            ...
            if (registry.wonPostDefGoal < 1 || registry.wonPostDefGoal < "1") {
                this.botText.text = "status: available " + (parseInt(registry.GoalPostDef)) + "/10";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 10:
            ...
            if (registry.wonTrophyBronze < 6 || registry.wonTrophyBronze < "6") {
        ...
        case 11:
            ...
            if (registry.wonTrophySilver < 6 || registry.wonTrophySilver < "6") {
        ...
        case 12:
            ...
            if (registry.wonTrophyGold < 6 || registry.wonTrophyGold < "6") {
        ...
        case 13:
            ...
            if (registry.wonTrophyPlatinum < 4 || registry.wonTrophyPlatinum < "4") {
            ...
            break;
        case 14:
            this.topText.text = "100x Coins in game";
            this.midText.text = "Collect 100 coins in game";
            if (registry.won100money < 1 || registry.won100money < "1") {
                this.botText.text = "status: available " + (parseInt(registry.storiesMoney)) + "/100";
            } else {
                this.botText.text = "status: done";
            }
            break;
        case 15:
            this.topText.text = "10x Double Posts + goal";
            this.midText.text = "Do 10x the ball to touch \nthe two posts + goal";
            if (registry.won2Post < 1 || registry.won2Post < "1") {
                this.botText.text = "status: available " + (parseInt(registry.aux2Post)) + "/10";
            } else {
                this.botText.text = "status: done";
            }
            break;
